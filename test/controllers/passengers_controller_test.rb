...
class PassengersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create passenger" do
    assert_difference('Passenger.count') do
      post passengers_url, params: { passenger: { enabled: @passenger.enabled, first_name: @passenger.first_name, identification: @passenger.identification, last_name: @passenger.last_name } }
    end
  ...
  test "should update passenger" do
    patch passenger_url(@passenger), params: { passenger: { enabled: @passenger.enabled, first_name: @passenger.first_name, identification: @passenger.identification, last_name: @passenger.last_name } }
